...
<!--         @endif -->
        ...
        <div class="container-fluid mr-auto p-3" style="background-image: linear-gradient(to right, rgba(26,157,217,0.80) , white);">
				...
				<div class="collapse navbar-collapse justify-content-md-center"
					...
					<ul class="navbar-nav">
						...
						<li class="nav-item active" ><a class="nav-link oMenu font-weight-bold"  href="{{ url('/'.Config::get('app.locale').'/about') }}">@lang('About_nav')  
						</a></li>
						<li class="nav-item"><a class="nav-link oMenu font-weight-bold"
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item" href="{{ url('/'.Config::get('app.locale').'/tips') }}">Tips for adult educators</a>
						...
						<li class="nav-item" style="border-bottom:4px solid #54b3df"><a class="nav-link oMenu font-weight-bold "
							href="{{ url('/'.Config::get('app.locale').'/survey') }}">@lang('Survey_nav')<span
        ...
        <div class="container">
            <div class="py-3 text-center">
                ...
                <p class="">@lang('t_survey')
                </p>
                <p>@lang('t_survey_p1')</p>
                <p>@lang('t_survey_p2') </p>
                <p>@lang('t_survey_p3')</p>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <form class="needs-validation" novalidate method="POST" action="{{ url('/'.Config::get('app.locale').'/survey') }}" autocomplete="off">
                        @csrf
            ...
            <hr>
            <p class="text-center mt-3">If you want to learn more about our project results and activities, contact us:
            <b>contact@openyoureyes.info</b></p>
            <hr my-5>
