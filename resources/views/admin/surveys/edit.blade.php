        ...
        <div class="row pt-3"><div class="col"><a class="btn btn-secondary" href="{{route('survey.list')}}" role="button">Cancel</a></div></div>
            ...
            <div class="row mb-4">
                ...
                <div class="col-md-12">
                    ...
                    <form class="needs-validation" novalidate method="POST" action="{{ route('survey.update',$survey->id)}}" autocomplete="off">
                    	
                        @csrf
                        <p>Do you agree with the intended use of the information described above ? <span style="color:red">*</span>                            </p>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input disabled" type="radio" name="intended_use" id="intended_use_true" readonly value="1" {{ ($survey->intended_use)=="1"
                                ? " checked ": '' }}>
                            <label class="form-check-label" for="intended_use_true">Yes</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="intended_use" id="intended_use_false" readonly value="0" {{ ( $survey->intended_use)=="0"
                                ? " checked ": '' }}>
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="quote_name" id="quote_name_true" readonly value="1" {{ ( $survey->quote_name)=="1"
                                ? " checked ": '' }}>
                            <label class="form-check-label" for="quote_name_true">Yes</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="quote_name" id="quote_name_false" readonly value="0" {{ ($survey->quote_name)=="0"
                                ? " checked ": '' }}>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" maxlength="150" class="form-control" name="first_name" id="first_name" readonly placeholder="" value="{{ $survey->first_name }}"
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" maxlength="150" class="form-control" name="last_name" id="last_name" readonly placeholder="" value="{{ $survey->last_name }}" 
                                required="required">   @if ($errors->has('last_name'))
                        ...
                        <div class="mb-3">
                            ...
                            <input type="email" maxlength="190" class="form-control" id="email" name="email" readonly placeholder="" required="required" value="{{ $survey->email  }}">                            
                            @if ($errors->has('email'))
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" maxlength="190" class="form-control" id="organisation" name="organisation" readonly placeholder="" value="{{ $survey->organisation }}"
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" maxlength="190" class="form-control" id="role_within_organisation" readonly name="role_within_organisation" value="{{ $survey->role_within_organisation }}"
                                placeholder="">
                        </div>
                        <hr class="mb-4">
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="text" maxlength="190" class="form-control" id="name_initiative_project" name="name_initiative_project" placeholder="" value="{{ $survey->name_initiative_project }}"
                                    required="">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="text" maxlength="200" class="form-control" id="web_initiative_project" name="web_initiative_project" value="{{ $survey->web_initiative_project }}"
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="text" maxlength="190" class="form-control" id="sponsor_initiative_project" name="sponsor_initiative_project"  placeholder=""
                                    value="{{ $survey->sponsor_initiative_project }}" required="">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="text" maxlength="190" class="form-control" name="location_initiative_project" id="location_initiative_project" placeholder=""
                                    value="{{ $survey->location_initiative_project }}" required="">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <input type="text" maxlength="190" class="form-control" id="country_initiative_project" name="country_initiative_project"  placeholder=""
                                    value="{{ $survey->country_initiative_project }}" required="">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control" name="start_date_initiative_project" value=""
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea   class="form-control" id="brief_aim_initiative_project" name="brief_aim_initiative_project" rows="3">{{ $survey->brief_aim_initiative_project }}</textarea>
                                <div class="invalid-feedback">
                                </div>
                            </div>
                            <div class="col-md-12 mb-3">
                                <label for="brief_expected_initiative_project">Brief overview of expected results (up to 200 words): </label>
                                <textarea   class="form-control" id="brief_expected_initiative_project" name="brief_expected_initiative_project" rows="3">{{ $survey->brief_expected_initiative_project }}</textarea>
                                <div class="invalid-feedback">
                                </div>
                            </div>
                            <div class="col-md-12 mb-3">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="1" {{ ($survey->online_initiative) == "1" ? " checked ": '' }} id="online_initiative"
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="1" {{ ($survey->offline_initiative) == "1" ? " checked ": '' }} id="offline_initiative"
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="1" {{ ( $survey->workshops_initiative)=="1" ? " checked ": '' }} id="workshops_initiative"
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="1" {{  ($survey->toolkit_initiative) =="1" ? " checked ": '' }}id="toolkit_initiative"
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="1" {{  ($survey->education_program_initiative)=="1" ? " checked ": ''
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="1" {{ ($survey->game_initiative)=="1" ? " checked ": '' }}id="game_initiative"
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="1" {{ ($survey->media_initiative)=="1" ? " checked ": '' }}id="media_initiative"
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="1" {{ ($survey->fact_initiative)=="1" ? " checked ": '' }}id="fact_initiative"
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="1" {{ ($survey->event_initiative)=="1" ? " checked ": '' }}id="event_initiative"
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="1" {{ ($survey->other_initiative)=="1" ? " checked ": '' }}id="other_initiative"
                                ...
                                <textarea class="form-control" maxlength="21000" id="other_initiative_description" name="other_initiative_description" rows="3">{{ $survey->other_initiative_description }}</textarea>
                            </div>
                            <div class="col-md-12 mb-3">
                                <p>What is your targeted audience: </p>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="1" {{ ( $survey->kids_initiative)=="1" ? " checked ": '' }}id="kids_initiative"
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="1" {{ ($survey->teenagers_initiative)=="1" ? " checked ": '' }} id="teenagers_initiative"
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="1" {{ ( $survey->young_adults_initiative)=="1" ? " checked ": '' }}id="young_adults_initiative"
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="1" {{ ( $survey->adults_initiative)=="1" ? " checked ": '' }}id="adults_initiative"
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="1" {{ ( $survey->elderly_initiative)=="1" ? " checked ": '' }}id="elderly_initiative"
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="1" {{ ($survey->teachers_educators_initiative)=="1" ? " checked ": ''
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="1" {{ ( $survey->professionals_initiative)=="1" ? " checked ": '' }} id="professionals_initiative"
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="1" {{ ( $survey->other_target_initiative)=="1" ? " checked ": '' }} id="other_target_initiative"
                                ...
                                <textarea class="form-control" maxlength="21000" id="other_target_initiative_description" name="other_target_initiative_description" rows="3">{{ $survey->other_target_initiative_description }}</textarea>


                                <p class="mt-4"> Do you have a specific focus, e.g. misinformation around elections, medical misinformation?</p>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="specific_focus_initiative" id="specific_focus_initiative_true" value="1" {{ ( $survey->specific_focus_initiative)=="1"
                                        ? " checked ": '' }}>
                                    <label class="form-check-label" for="specific_focus_initiative_true">Yes</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="specific_focus_initiative" id="specific_focus_initiative_false" value="0" {{ ( $survey->specific_focus_initiative)=="0"
                                        ? " checked ": '' }}>
                                ...
                                <textarea maxlength="21000"  class="form-control" id="specific_focus_initiative_description" name="specific_focus_initiative_description" rows="3">{{ $survey->specific_focus_initiative_description }}</textarea>
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="1" {{ ( $survey->global_platform_initiative)=="1" ? " checked ": '' }}
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="1" {{ ( $survey->website_platform_initiative)=="1" ? " checked ": '' }}
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="1" {{ ( $survey->search_engine_platform_initiative)=="1" ? " checked ":
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="1" {{ ( $survey->video_platform_initiative)=="1" ? " checked ": '' }}
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="1" {{ ( $survey->sopen_social_platform_initiative)=="1" ? " checked ":
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="1" {{ ( $survey->forum_platform_initiative)=="1" ? " checked ": '' }}
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="1" {{ ( $survey->close_social_platform_initiative)=="1" ? " checked ":
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="1" {{ ( $survey->other_platform_initiative)=="1" ? " checked ": '' }}
                                ...
                                <textarea class="form-control" maxlength="21000" id="other_platform_initiative_description" name="other_platform_initiative_description" rows="3">{{ $survey->other_platform_initiative_description }}</textarea>
                            </div>
                            ...
                            <div class="col-md-12 mb-3">
                                <p>Disinformation spreads through different types of media: which one(s)
                                    does your initiative tackle? </p>
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="1" {{ ( $survey->multimedia_modality_platform)=="1" ? " checked ": ''
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="1" {{ ( $survey->text_only_modality_platform)=="1" ? " checked ": '' }}
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="1" {{ ( $survey->images_only_modality_platform)=="1" ? " checked ": ''
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="1" {{ ( $survey->video_only_modality_platform)=="1" ? " checked ": ''
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="1" {{ ( $survey->audio_only_modality_platform)=="1" ? " checked ": ''
                                ...
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="1" {{ ( $survey->other_modality_platform)=="1" ? " checked ": '' }} id="other_modality_platform"
                                ...
                                <textarea  maxlength="21000" class="form-control" id="other_modality_platform_description" name="other_modality_platform_description" rows="3">{{ $survey->other_modality_platform_description }}</textarea>
                            </div>
                        </div>
                        ...
                        <textarea maxlength="21000"  class="form-control" id="term_adequate_description" name="term_adequate_description" rows="3">{{ $survey->term_adequate_description }}</textarea>
                        ...
                        <textarea maxlength="21000"  class="form-control" id="term_difference_description" name="term_difference_description" rows="3">{{ $survey->term_difference_description }}</textarea>
                        ...
                        <textarea maxlength="21000"  class="form-control" id="other_initiatives_collaboration_description" name="other_initiatives_collaboration_description"
                            rows="3">{{ $survey->other_initiatives_collaboration_description }}</textarea>
                        ...
                        <textarea maxlength="21000"  class="form-control" id="other_initiatives_aware_description" name="other_initiatives_aware_description" rows="3">{{ $survey->other_initiatives_aware_description }}</textarea>
                        ...
                        <textarea maxlength="21000"  class="form-control" id="other_initiatives_join_description" name="other_initiatives_join_description" rows="3">{{ $survey->other_initiatives_join_description }}</textarea>


						 <hr class="mb-4">
                        <h4 class="mb-3 sub-title "><b>Admin Fields</b> </h4>
                          <p class="mt-4">Quote</p>
                        <textarea maxlength="21000"  class="form-control" id="admin_quote" name="admin_quote" rows="3">{{ $survey->admin_quote }}</textarea>
                          <p class="mt-4">Link to external resource</p>
                        <textarea maxlength="21000"  class="form-control" id="admin_link_external_resource" name="admin_link_external_resource" rows="3">{{ $survey->admin_link_external_resource }}</textarea>
                        <hr class="mb-4">
                        <button class="btn btn-primary btn-lg btn-block" type="submit" style="background-color:#54B3DF">Update</button>
                    </form>
                </div>
            </div>
    ...
    <script>
      $( function() {
        $( "#start_date_initiative_project" ).datepicker({
       	...
       	$( "#start_date_initiative_project" ).datepicker( "setDate", "{{ $survey->start_date_initiative_project }}" );
       	...
       	$( "#end_date_initiative_project" ).datepicker( "setDate", "{{ $survey->end_date_initiative_project }}" );


       	document.getElementById("intended_use_true").disabled = true;
       	document.getElementById("intended_use_false").disabled = true;
       	document.getElementById("quote_name_true").disabled = true;
       	document.getElementById("quote_name_false").disabled = true;
       	//document.getElementById("specific_focus_initiative_true").disabled = true; 
       	//document.getElementById("specific_focus_initiative_false").disabled = true;  
    	//document.getElementById("multimedia_modality_platform").disabled = true;  
    	//document.getElementById("text_only_modality_platform").disabled = true;
    	//document.getElementById("images_only_modality_platform").disabled = true;
    	//document.getElementById("video_only_modality_platform").disabled = true;
    	//document.getElementById("audio_only_modality_platform").disabled = true;
    	//document.getElementById("other_modality_platform").disabled = true;
