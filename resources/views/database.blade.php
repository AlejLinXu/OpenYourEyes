	...
	<div class="flex-center position-ref full-height">
		...
		<div class="container py-3">
			<div class="row text-center">
				<div class="col-12">
					<img class="d-block mx-auto mb-4" src="{{ URL::to('/') }}/images/logo-title.png"
			...
			<div class="row text-center">
				<div class="col-12">
					<h3>@lang('t_database')</h3>
					<h5></h5>
					<p class="text-justify">@lang('t_database_p1')</p>
					<p class="mt-2 text-justify">@lang('t_database_p2')
					
					
					<ul class="mt-2 text-justify">
						<li class="mt-2 pl-2">@lang('t_database_p3')</li>
						<li class="mt-2 pl-2">@lang('t_database_p4')</li>
						<li class="mt-2 pl-2">@lang('t_database_p5')</li>
					</ul>
					</p>
			...
			<div class="row text-center">
				<img src="{{ URL::to('/') }}/images/graph_database.png"
					class="img-fluid mx-auto d-block" alt="" style="max-width: 540px">
				

			</div>
			<div class="row text-center justify-content-center" ><p class="mt-2 text-justify">@lang('t_database_p6')</p></div>
			<div class="row text-center justify-content-center">
			
				<a href="database/list" role="button" class="btn btn-secondary btn-lg mt-3">Check It Out database </a>
			</div>
		</div>
